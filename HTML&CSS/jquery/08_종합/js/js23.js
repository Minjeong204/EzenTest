$(document).ready(function () {
  ...
  $(window).scroll(function () {
    ...
    if ($(this).scrollTop() > 1200) {
      ...
      $("#number_wrap > li:nth-child(1) > h3").animate(
        { marginLeft: "0" },
        2000
      );
      $("#number_wrap > li:nth-child(1) > p")
        .delay(1000)
    ...
    if ($(this).scrollTop() > 1500) {
      ...
      $("#number_wrap > li:nth-child(2) > h3").animate(
        { marginLeft: "0" },
        2000
      );
      $("#number_wrap > li:nth-child(2) > p")
        .delay(1000)
        .animate({ marginLeft: "0" }, 2000);
    }
    if ($(this).scrollTop() > 1800) {
      ...
      $("#number_wrap > li:nth-child(3) > h3").animate(
        { marginLeft: "0" },
        2000
      );
      $("#number_wrap > li:nth-child(3) > p")
        .delay(1000)
        .animate({ marginLeft: "0" }, 2000);
    }
    if ($(this).scrollTop() > 2100) {
      ...
      $("#number_wrap > li:nth-child(4) > h3").animate(
        { marginLeft: "0" },
        2000
      );
      $("#number_wrap > li:nth-child(4) > p")
        .delay(1000)
        .animate({ marginLeft: "0" }, 2000);
    }
  });
